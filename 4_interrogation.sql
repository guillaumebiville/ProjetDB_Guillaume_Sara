...
-- afficher les matchs avec le nom du stade correspondant
...
-- afficher les joueurs qui n'ont participée à aucun match
...
-- afficher les matchs joués dans un stade de capacité supérieure à 40000
